...
export const ParticleNetwork: React.FC = () => {
  ...
  useEffect(() => {
      ...
      for (let i = 0; i < numBasePairs; i++) {
        ...
        renderQueue.push({
          ...
          draw: () => {
            ...
            grad.addColorStop(0, `rgba(57, 255, 20, ${lineAlpha})`);
            grad.addColorStop(1, `rgba(223, 255, 0, ${lineAlpha})`);
    ...
    const animate = () => {
      ...
      gradient.addColorStop(0.3, 'rgba(57, 255, 20, 0.03)');
      gradient.addColorStop(1, 'rgba(2, 27, 21, 0)');
      ctx.fillStyle = gradient;
      ctx.fillRect(0, 0, canvas.width, canvas.height);

      // Bottom horizon glow
      const horizonGradient = ctx.createLinearGradient(0, canvas.height, 0, canvas.height * 0.7);
      horizonGradient.addColorStop(0, 'rgba(223, 255, 0, 0.06)');
      horizonGradient.addColorStop(1, 'rgba(223, 255, 0, 0)');
