...
export const FloatingContact = () => {
  ...
  const handlePhoneClick = () => {
    navigator.clipboard.writeText(config.contact.phone || "17717473904");
    showToast("联系电话已复制");
  };
  ...
  const handleAIClick = () => {
    ...
    if (container) {
      ...
      const aliyunBtn = (container.querySelector(
  ...
  return (
    <>
      {/* Global Toast */}
      {toastMessage && (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-slate-900/90 text-white px-6 py-3 rounded-xl shadow-2xl z-[2147483647] animate-in fade-in zoom-in-95 duration-200 pointer-events-none">
